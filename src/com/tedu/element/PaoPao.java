...
public class PaoPao extends ElementObj {
    ...
    public void reloadBubble(GameElement ge) {
        List<ElementObj> list2 = ElementManager.getManager().getElementsByKey(ge);
    ...
    public void die(long gameTime) { // 死亡也是一个对象
        if (!isLive()) {
            ...
            reloadBubble(GameElement.PLAYER);
            reloadBubble(GameElement.ENEMY);
